...
var ResourceRemover = /*#__PURE__*/function (_ResourcesRemover) {
  function ResourceRemover(model, params, user) {
    ...
    return _callSuper(this, ResourceRemover, [model, params, [params.recordId], user]);
  }
  (0, _inherits2["default"])(ResourceRemover, _ResourcesRemover);
  return (0, _createClass2["default"])(ResourceRemover, [{
    key: "perform",
    value: function perform() {
      if (!this._params.recordId) {
        return null;
      }
      return _superPropGet(ResourceRemover, "perform", this, 3)([]);
    }
  }]);
